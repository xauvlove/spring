package com.xauv.springframework.context.imitate.mybatis.ibdr;/*
package com.xauv.springframework.context.imitate.mybatis.ibdr;

import com.xauv.springframework.context.imitate.mybatis.dao.MybatisDao;
import com.xauv.springframework.context.imitate.mybatis.factoryBean.MyDaoFactoryBean;
...
public class MybatisImportBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
		...
		beanDefinition.getConstructorArgumentValues()
				.addGenericArgumentValue("com.xauv.springframework.context.imitate.mybatis.dao.MybatisDao");
